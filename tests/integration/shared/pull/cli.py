...
def gurk_pull(
    ...
    """
    Helper function to execute the 'gurk pull' command and capture its output.

    :param argv: List of command-line arguments to pass to 'gurk pull'.
    :type argv: list[str]
    ...
    # Execute the 'gurk pull' command
    with pytest.raises(SystemExit) as e:
        pull.main(
            argv,
            prog="gurk pull",
            description="Pull a plugin from a remote source.",
        )
