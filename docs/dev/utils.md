...
3. Other utility modules in `lib/utils/` (can also be used by Python scripts)
4. `plugins.py`: Plugin utilities
5. Other utility modules in `lib/helpers/python/` (should only be used by Python scripts)
