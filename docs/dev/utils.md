...
3. Other utility modules in `src/cmstp/utils/` (can also be used by Python scripts)
4. Other utility modules in `src/cmstp/scripts/python/helpers/` (should only be used by Python scripts)
